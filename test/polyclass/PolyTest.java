...
public class PolyTest {
    ...
    public void division() {
        assertEquals(new Poly(new int[]{1, 1, 1}).division(new Poly(new int[]{1, 1, 1})), new Poly(new int[]{1}));
        assertEquals(new Poly(new int[]{1, 1, 1}).division(new Poly(new int[]{1, 1})), new Poly(new int[]{0, 1}));
        assertEquals(new Poly(new int[]{1, 1, 1}).division(new Poly(new int[]{0, 1})), new Poly(new int[]{1, 1}));
    }

    @Test
    public void remainder() {
        assertEquals(new Poly(new int[]{1, 1, 1}).remainder(new Poly(new int[]{1, 1, 1})), new Poly(new int[]{}));
        assertEquals(new Poly(new int[]{1, 1, 1}).remainder(new Poly(new int[]{1, 1})), new Poly(new int[]{1}));
        assertEquals(new Poly(new int[]{1, 1, 1}).remainder(new Poly(new int[]{0, 1})), new Poly(new int[]{1}));
    }
